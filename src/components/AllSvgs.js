...
export const DownArrow = (props) => {
  return (
    ...
    {...props}
  >
    <path d="M310 526.5c0 468.8-.1 514.6-1.6 515.2-.9.3-4.1 0-7.2-.7-13.2-2.9-28.6-10.8-38.4-19.9-3.2-2.9-5.8-4.9-5.8-4.4 0 1.6 62 256.6 62.5 257.1.2.3.7-.1.9-.9.9-2.7 61.6-253.9 61.6-255 0-.6-2.4.9-5.2 3.3-7.6 6.4-14 10.6-21.3 13.9-6.9 3.1-19.6 6.9-23.2 6.9H330l-.2-514.8-.3-514.7-9.7-.3-9.8-.3v514.6z" />
  </svg>
  )
}